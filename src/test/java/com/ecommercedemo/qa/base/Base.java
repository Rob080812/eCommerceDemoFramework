package com.ecommercedemo.qa.base;
...
public class Base {
	...
	public Base() {
		...
		File propFile = new File(System.getProperty("user.dir")
				+ "\\src\\main\\java\\com\\ecommercedemo\\qa\\config\\config.properties");

		dataProp = new Properties();
		File dataPropFile = new File(System.getProperty("user.dir")
				+ "\\src\\main\\java\\com\\ecommercedemo\\qa\\testdata\\testdata.properties");
		try {
